...
from .views import UserView, mockView, CustomTokenObtainPairView, ProfileView
...
urlpatterns = [
    ...
    path('mock/', mockView.as_view(), name='mock_view'), #로그인 기능 테스트
    path('getuserinfo/', ProfileView.as_view(), name='getuserinfo'), #로그인 기능 테스트
]